...
public class InserimentoDatiGenerali extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inserimento_dati_generali);
        ...
        final SharedPreferences settings = getSharedPreferences("datiUtente", 0);
        ...
        if (firstRun == false) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(InserimentoDatiGenerali.this);
            builder.setMessage("Inserisci i tuoi dati di accesso ").setPositiveButton("Chiudi", null)
                    .create()
                    .show();
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (TextUtils.isEmpty(etxt.getText().toString()) || TextUtils.isEmpty(etxt2.getText().toString())) {
                        ...
                        Toast.makeText(InserimentoDatiGenerali.this,"Compila tutti i campi",Toast.LENGTH_LONG).show();
                        ...
                        editor2.putString("nomeUtente", nome);
                        editor2.putString("passwordUtente", password);
                        editor2.commit();

                        Intent intent = new Intent(InserimentoDatiGenerali.this, MainActivity.class);
